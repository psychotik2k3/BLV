...
; Drives
M569 P0.0 S0 D3 V50                                                             ; physical drive 0.0 goes backwards (DIAG front right rear left)
M569 P0.1 S0 D3 V50                                                             ; physical drive 0.1 goes forwards  (other diagonal)
M569 P0.2 S1 D3                                                             ; physical drive 0.2 goes backwards  (z right)
M569 P0.3 S1 D3                                                             ; physical drive 0.3 goes backwards  (z left)
M569 P1.0 S1 D3                                                             ; physical drive 1.0 goes backward  (tool 0) 
...
M566 X700.00 Y700.00 Z24.00 E2000.00:2000.00:2000.00                        ; set maximum instantaneous speed changes (mm/min)
;M203 X1080000.00 Y1080000.00 Z60000.00:60000.00 E72000.00:72000.00:72000.00 ; set maximum speeds (mm/min)
M203 X18000.00 Y18000.00 Z999.00 E1200.00:1200.00:1200.00                   ; set maximum speeds (mm/min)
M201 X3000.00 Y3000.00 Z100.00 E4000.00:4000.00:4000.00                     ; set accelerations (mm/s^2)
M906 X2000 Y2000 Z1000 E2000:800:950 I30                               ; set motor currents (mA) and motor idle factor in per cent
...
;M307 H3 B0 R3.132 C237.0:118.4 D8.47 S1.00 V23.7
M307 H3 B0 R3.184 C232.0:106.7 D8.08 S1.00 V23.7
...
;G10 P0 X0 Y-27.6 Z1.76                                                             ; set tool 0 axis offsets head touch at 2.65mm
;G10 P0 X0 Y-27.6 Z2.76                                                             ; set tool 0 axis offsets head touch bed at 3.65mm
G10 P0 X0 Y-27.6 Z-0.87                                                             ; set tool 0 axis offsets
...
;G10 P1 X0.2 Y-27.8 Z-0.379                                                             ; set tool 1 axis offsets
;G10 P1 X0.2 Y-27.7 Z-0.379                                                             ; set tool 1 axis offsets
G10 P1 X0.2 Y-27.6 Z-0.379                                                             ; set tool 1 axis offsets
